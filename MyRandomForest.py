...
class MyRandomForestClassifier():
    ...
    def randomForestSMOTE(self,featureMatrix,phishingURLLabel,fakeFeatureMatrix,fakeLabels,technique):
        ...
        predictionResult.write("Random Forest Classification with SMOTE Completed with Avg. Score: " + str(np.mean(accuracy_matrix)))
    ...
    def randomForestb2SMOTE(self,featureMatrix,phishingURLLabel,fakeFeatureMatrix,fakeLabels,technique):
        ...
        predictionResult.write("Random Forest Classification with Borderline-2 SMOTE Completed with Avg. Score: " + str(np.mean(accuracy_matrix)))
    ...
    def randomForestSVM_Smote(self,featureMatrix,phishingURLLabel,fakeFeatureMatrix,fakeLabels,technique):
        ...
        predictionResult.write("Random Forest Classification with SVM Smote Oversampling Completed with Avg. Score: " + str(np.mean(accuracy_matrix)))
    ...
    def randomForestRMR(self,featureMatrix,phishingURLLabel,fakeFeatureMatrix,fakeLabels,technique):
        ...
        predictionResult.write("Random Forest Classification with Random Minority Oversampling Completed with Avg. Score: " + str(np.mean(accuracy_matrix)))
    ...
    def randomForestADASYN(self,featureMatrix,phishingURLLabel,fakeFeatureMatrix,fakeLabels,technique):
        ...
        predictionResult.write("Random Forest Classification with ADASYN Oversampling Completed with Avg. Score: " + str(np.mean(accuracy_matrix)))